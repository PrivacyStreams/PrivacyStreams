...
public class MultiItemStream extends Stream implements IMultiItemStream {
    ...
    public MultiItemStream(Function<Void, MultiItemStream> streamProvider, UQI uqi) {
        super(uqi);
     ...
     */
    public MultiItemStream transform(Function<MultiItemStream, MultiItemStream> streamTransformation) {
     ...
     */
    public SingleItemStream transformToItem(Function<MultiItemStream, SingleItemStream> streamTransformation) {
        return streamTransformation.apply(this.getUQI(), this);
    }
