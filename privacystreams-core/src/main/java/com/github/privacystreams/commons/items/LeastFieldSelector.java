...
/**
 * select an item from the stream that has the least elements in a list field.
 * return null if fails to find an item
 */

class LeastFieldSelector extends ByFieldItemSelector {
    LeastFieldSelector(String listField) {
        super(listField);
    }
