 ...
 */
final class FieldEqualOperator<TValue> extends ItemFieldOperator<TValue> {
    final static String OPERATOR_EQ = "$field_eq";
    final static String OPERATOR_NE = "$field_ne";

    FieldEqualOperator(final String operator, final String field, final TValue valueToCompare) {
